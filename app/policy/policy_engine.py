...
class PolicyEngine:
    ...
    def evaluate_autonomy(self, case: RecoveryCase, action: Action) -> PolicyEvaluation:
        raise NotImplementedError(
            "TODO: Policy track — see implementation_plan.md §7.1, §7.7"
        )

    def human_approval_required(self, case: RecoveryCase, action: Action) -> bool:
        raise NotImplementedError(
            "TODO: Policy track — see implementation_plan.md §7.7"
        )
