...
class ContactPolicyEngine:
    ...
    def load_from_yaml(self, path: str) -> None:
        raise NotImplementedError("TODO: Policy track — see implementation_plan.md §7.2")

    def is_contact_allowed(
        self, channel: Channel, at: datetime, customer_preference: tuple[str, ...]
    ) -> bool:
        raise NotImplementedError("TODO: Policy track — see implementation_plan.md §7.2, §7.4")
